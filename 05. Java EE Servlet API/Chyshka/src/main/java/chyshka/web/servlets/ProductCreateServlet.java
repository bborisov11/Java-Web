...
public class ProductCreateServlet extends HttpServlet {
    ...
    private static final String CREATE_PRODUCT_HTML_FILE_PATH = "D:\\SoftUni\\Java-Web\\05. Java EE Servlet API\\Chyshka\\src\\main\\resources\\views\\create-product.html";
    ...
    private String formatTypeOptions() {
        ...
        Arrays.stream(Type.values()).forEach(type -> options
                .append(String.format("<option value=\"%s\">%s</option>",
                type.name(), type.name())).append(System.lineSeparator()));
