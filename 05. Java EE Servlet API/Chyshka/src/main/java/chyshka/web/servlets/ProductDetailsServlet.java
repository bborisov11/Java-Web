...
public class ProductDetailsServlet extends HttpServlet{
    ...
    private final static String PRODUCT_DETAILS_HTML_FILE_PATH = "D:\\SoftUni\\Java-Web\\05. Java EE Servlet API\\Chyshka\\src\\main\\resources\\views\\detail-product.html";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ProductDetailsViewModel productDetailsViewModel = this.modelMapper
                .map(this.productService.findByName(req.getQueryString()
